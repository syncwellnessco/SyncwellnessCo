      ...
      <div className="w-full lg:w-1/2 flex items-start lg:items-center justify-center px-6 pt-24 pb-12 sm:px-12 sm:pt-24 lg:px-16 lg:py-12">
        <div className="w-full max-w-md mt-4 lg:mt-0">
          ...
          <div className="relative flex items-center my-8">
            ...
            <span className="flex-shrink-0 px-4 text-xs tracking-wider uppercase font-semibold text-charcoal/50">or sign up with email</span>
            <div className="flex-grow border-t border-[#DCD3C6]"></div>
          </div>
          ...
          <form className="space-y-8" onSubmit={handleSignup}>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-0 top-1/2 -translate-y-1/2 text-charcoal/60 hover:text-charcoal transition-colors p-1"
