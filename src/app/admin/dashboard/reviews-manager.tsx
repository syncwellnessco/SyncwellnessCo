            ...
            <div className="p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#FAF8F5] p-5 rounded-lg border border-[#EBE3DB] space-y-5">
                  ...
                  {viewReview.status === 'published' && (
                    <div className="pt-4 border-t border-[#EBE3DB] flex items-center gap-3">
                      <input 
                        type="checkbox" 
                        id="featured" 
                        checked={viewReview.featured_on_home} 
                        onChange={(e) => updateStatus(viewReview.id, { featured_on_home: e.target.checked })}
                        className="w-4 h-4 text-[#8C6D40] rounded border-gray-300 focus:ring-[#8C6D40]"
                      />
                      <label htmlFor="featured" className="font-medium text-charcoal text-sm cursor-pointer">
